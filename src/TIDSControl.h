...
// Relays are P8_28 - P8_42 (8 to 1)

#define TIDS_POWERCONTROLLER_PIN_RELAYCHILLER_GPIO bbbkit::GPIO::PIN::P8_42 // Relay 1
#define TIDS_POWERCONTROLLER_PIN_RELAYMOTORZ_GPIO bbbkit::GPIO::PIN::P8_40 //Relay 2
#define TIDS_POWERCONTROLLER_PIN_RELAYMOTORX_GPIO bbbkit::GPIO::PIN::P8_38 // Relay 3
#define TIDS_POWERCONTROLLER_PIN_RELAYDRILLMOTOR_GPIO bbbkit::GPIO::PIN::P8_36 // Relay 4
#define TIDS_POWERCONTROLLER_PIN_RELAY24V_GPIO bbbkit::GPIO::PIN::P8_34 // Relay 5
#define TIDS_POWERCONTROLLER_PIN_RELAYPROXIMITYSENSORS_GPIO bbbkit::GPIO::PIN::P8_32 // Relay 6
#define TIDS_POWERCONTROLLER_PIN_RELAYHEATER1_GPIO bbbkit::GPIO::PIN::P8_30 // Relay 7
#define TIDS_POWERCONTROLLER_PIN_RELAYHEATER2_GPIO bbbkit::GPIO::PIN::P8_28 // Relay 8
...
public:
    ...
    int moveXAxisToHomeAndCalibrate();
    int moveZAxisToHome();
    int startMovingZAxisDown();
    int openHeaterCapMotor();
    int closeHeaterCapMotor();
