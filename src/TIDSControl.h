...
#define TIDS_POWERCONTROLLER_PIN_RELAYCHILLER_GPIO bbbkit::GPIO::PIN::P9_42 // Relay 1
#define TIDS_POWERCONTROLLER_PIN_RELAYHEATER1_GPIO bbbkit::GPIO::PIN::P9_40 // Relay 2
#define TIDS_POWERCONTROLLER_PIN_RELAYHEATER2_GPIO bbbkit::GPIO::PIN::P9_38 // Relay 3
#define TIDS_POWERCONTROLLER_PIN_RELAYDRILLMOTOR_GPIO bbbkit::GPIO::PIN::P9_36 // Relay 4
#define TIDS_POWERCONTROLLER_PIN_RELAYSTEPPERMOTORZ_GPIO bbbkit::GPIO::PIN::P9_34 //Relay 5
#define TIDS_POWERCONTROLLER_PIN_RELAYPROXIMITYSENSORS_GPIO bbbkit::GPIO::PIN::P9_32 // Relay 6
#define TIDS_POWERCONTROLLER_PIN_RELAYSTEPEPRMOTORX_GPIO bbbkit::GPIO::PIN::P9_30 // Relay 7
...
#define TIDS_HEATERCAPMOTOR_PIN_PWM bbbkit::GPIO::PIN::P9_16
