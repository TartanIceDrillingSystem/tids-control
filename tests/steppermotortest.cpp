...
int main(int argc, char **argv) {
    ...
    cout << "1 revolution CW @ 12rpm (5 seconds)...";
    ...
    cout << "10 revolutions CW @ 60rpm (10 seconds)...";
    ...
    cout << "10 revolutions CCW @ 100rpm (10 seconds)...";
    ...
    cout << "Sleeping motor for 5 seconds...";
    ...
    cout << "Waking motor for 5 seconds...";
